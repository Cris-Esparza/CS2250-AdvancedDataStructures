...
void copyCase(vector<TrophyCase>& trophyCases)
{
	...
	int caseIndex = promptForInt(PROMPT_FOR_CASE_NUMBER_COPY, 1, (int)trophyCases.size()) - 1;
...
void overwriteCase(vector<TrophyCase>& trophyCases)
{
	...
	int copyIndex = promptForInt(PROMPT_FOR_CASE_NUMBER_COPY, 1, (int)trophyCases.size()) - 1;
	int overwriteIndex = promptForInt(PROMPT_FOR_CASE_NUMBER_OVERWRITE, 1, (int)trophyCases.size()) - 1;
...
void deleteCase(vector<TrophyCase>& trophyCases)
{
	...
	int index = promptForInt(PROMPT_FOR_CASE_NUMBER, 1, (int)trophyCases.size()) - 1;
